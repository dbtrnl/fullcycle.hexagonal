...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fullcycle.hexagonal.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".fullcycle.hexagonal" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".fullcycle.hexagonal")
	}
